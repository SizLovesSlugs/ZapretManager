...
func (e *Chromium) CreateCoreWebView2ControllerCompleted(res uintptr, controller *ICoreWebView2Controller) uintptr {
	...
	// Dark default surface before any HTML paints (pairs with WEBVIEW2_DEFAULT_BACKGROUND_COLOR).
	if c2 := controller.GetICoreWebView2Controller2(); c2 != nil {
		_ = c2.PutDefaultBackgroundColor(COREWEBVIEW2_COLOR{A: 255, R: 0x0a, G: 0x0b, B: 0x0e})
	}
